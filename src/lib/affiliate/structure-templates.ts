...
export const affiliateStructureTemplates: AffiliateStructureTemplate[] = [
  {
    ...
    description: "Two-team structure with editable Left Team and Right Team labels, weaker-leg volume settings, pair-match settings, and optional spillover rules.",
  ...
  },
  {
    ...
    description: "Fixed width x depth structure with editable level labels, level percentages, matrix width/depth, and spillover mode.",
    bestUseCase: "Owners who need controlled grid placement, spillover, and structured level payouts.",
    complexity: "Medium",
    riskLevel: "medium",
    engineStatus: "scaffolded",
    defaultConfig: {
  ...
  },
  {
    ...
    description: "Unlimited frontline structure with editable labels and capped level-based qualified-purchase commissions up to seven levels.",
